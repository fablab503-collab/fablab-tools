...
The generated style (`assets/style.json`) is a modified "dark" flavor (pure black background and
earth, POI layers removed) and is not Protomaps-branded.
...
**Sprites** (`assets/sprites/v4/dark*`) — from https://github.com/protomaps/basemaps-assets,
derived from the MIT-licensed [tangrams/icons](https://github.com/tangrams/icons).
